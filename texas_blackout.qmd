...
```{r}
#| output: true
# Plot night lights before and after the storms
...
# Plot a map showing homes affected by the blackout
...
Apply intersection to capture the census tracts that intersect the homes that suffered from the blackout (including those partially inside).
...
Display the spatial distribution of median household income across census tracts that experienced blackout in Houston.
